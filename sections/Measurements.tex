...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item low-pass Butterworth filter with cut-off frequency of \SI{20}{\hertz} and length 5
            \item high-pass Butterworth filter with cut-off frequency of \SI{300}{\hertz} and length 5
        \end{itemize}
        \item Wiener filter
        \begin{itemize}
...
3 notch filters at \SI{50}{\hertz}, \SI{100}{\hertz}, and \SI{150}{\hertz}  with q-factor of 10, Band-pass filter consisting of a high-pass filter with cut-off frequency of \SI{20}{\hertz} and a low-pass filter with a cut-off frequency of
